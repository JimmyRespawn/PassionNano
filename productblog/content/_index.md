...
{{< hextra/feature-grid >}}
  ...
  >}}
  {{< hextra/feature-card  link="https://apps.microsoft.com/detail/9nl2q935957m?hl=en-US&gl=US&launch=true&mode=full&ocid=officialwebsite"
    title="Link for Tesla"
    subtitle="Unofficial Tesla app for Windows."
    class="hx-aspect-auto md:hx-aspect-[1.1/1] max-md:hx-min-h-[340px]"
