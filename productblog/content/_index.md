...
{{< hextra/feature-grid >}}
  {{< hextra/feature-card  link="https://apps.microsoft.com/detail/9pkmdlwbc8zj?launch=true&mode=full&ocid=officialwebsite"
    title="IPTV Fluent"
  ...
  >}}
  {{< hextra/feature-card  link="https://apps.microsoft.com/detail/9mx6kd8wgwgp?launch=true&mode=full&ocid=officialwebsite"
  ...
  >}}
  {{< hextra/feature-card  link="https://apps.microsoft.com/detail/9nxwgr2b1p26?launch=true&mode=full&ocid=officialwebsite"
    title="Podcasted"
  ...
  >}}
  {{< hextra/feature-card  link="https://apps.microsoft.com/detail/9ncf5gmw8q1q?launch=true&mode=full&ocid=officialwebsite"
    title="Movier"
    icon="movies"
    subtitle="Let you keep track of latest, popular, upcoming and top rated movies list."
  >}}
    {{< hextra/feature-card  link="https://apps.microsoft.com/detail/9wzdncrd1p4n?launch=true&mode=full&ocid=officialwebsite"
    title="Game Calendar"
    icon="games"
    subtitle="Let you keep track of the upcoming games on a variety of gaming platforms."
  >}}
    {{< hextra/feature-card  link="https://apps.microsoft.com/detail/9nblggh4whsp?launch=true&mode=full&ocid=officialwebsite"
    title="Amphetamine"
    icon="pills"
